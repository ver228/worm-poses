...
python $SCRIPTPATH --n_epochs 1000 --model_name 'CPMout-PAF' --dataset 'manually-annotated-PAF' \
--n_segments 25 --n_affinity_maps 20 --batch_size 16 --num_workers 8 --lr 0.0001
