...
__all__ = [
    "KeypointRCNN", "keypointrcnn_resnet50_fpn", "get_keypointrcnn"
]
...
class KeypointRCNN(FasterRCNN):
    ...
    def __init__(self, backbone, num_classes=None,
        ...
        if keypoint_predictor is None:
            ...
            keypoint_predictor = KeypointRCNNPredictorSotfmax(keypoint_dim_reduced, num_keypoints)
...
class KeypointRCNNPredictorSotfmax(nn.Module):
...
def get_keypointrcnn(backbone = 'resnet50', 
                     progress=True, pretrained_backbone=True, **kwargs):
    _backbone = resnet_fpn_backbone(backbone, pretrained_backbone)
    model = KeypointRCNN(_backbone,  **kwargs)
    return model
